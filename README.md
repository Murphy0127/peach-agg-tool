...
```bash
claude plugin add github:Murphy0127/peach-agg-tool
```
...
Plugin 通过 GitHub 安装后，执行 `/reload-plugins` 即可拉取最新版本。
...
```bash
# Plugin 方式安装的
claude plugin remove github:Murphy0127/peach-agg-tool
